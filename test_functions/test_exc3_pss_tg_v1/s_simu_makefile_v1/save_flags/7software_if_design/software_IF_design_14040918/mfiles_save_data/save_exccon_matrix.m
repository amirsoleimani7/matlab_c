...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function save_exccon_matrix(filename, matrix)
    fid = fopen(filename, 'w'); 
     [rows, cols] = size(matrix);
     scale = zeros(20,1);
    scale (1:20) = [2^0,2^0,2^10,2^0,2^10,2^7,2^7,2^4,2^4,2^7,2^7,2^4,2^4,2^4,2^4,2^7,2^7,2^7,2^7,2^7 ];% no exc_pot4 in ref table
     for i = 1:rows
        mac_num=  exc_con(i,2);
        mac_index = mac_num -1;
        for j = 1:cols
